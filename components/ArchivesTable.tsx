...
const dossiers = [
  ...
  { id: "ukr", name: "УССР", narkom: "В. Я. Чубарь", portrait: "/narkom_ukr.jpg", content: "Главный аграрный донор. Донбасс обеспечил 80% угля. Мощная сельхозкооперация победила голод.", stat: "80% добычи угля", compare: "Второе место по объему частного капитала." },
  { id: "blr", name: "БССР", narkom: "И. А. Адамович", portrait: "/narkom_blr.jpg", content: "Деревообработка и легкая пром-сть. НЭП восстановил артели и торговлю лесом с Европой.", stat: "40% рост легпрома", compare: "Самый высокий процент мелких артелей." },
  { id: "cau", name: "ЗСФСР", narkom: "Г. К. Орджоникидзе", portrait: "/narkom_cau.jpg", content: "Валютный цех. Баку давал нефть за золото. Концессии Shell модернизировали вышки.", stat: "100% экспорта нефти", compare: "Уникальный режим внешней торговли." },
  { id: "asia", name: "Ср. Азия", narkom: "Ф. Ходжаев", portrait: "/narkom_asia.jpg", content: "Хлопковый суверенитет. Восстановление ирригации. Льготы дехканам за выращивание сырья.", stat: "Рост хлопка в 3.5 раза", compare: "Медленная смычка из-за традиционного уклада." }
];
  ...
  return (
    <section id = "archives" className="min-h-screen w-full bg-[#1e231f] flex border-b-[16px] border-[#141414] relative overflow-hidden">
      ...
      <div className="flex-1 p-8 lg:p-16 relative z-10">
        ...
        {/* ДЕКОРАТИВНЫЕ ЭЛЕМЕНТЫ "МУСОРА" НА СТОЛЕ */}
            ...
            >
              ...
              <div className="w-full aspect-[3/4] bg-[#c4a484] border-l-[10px] border-[#8b7355] shadow-[10px_10px_20px_rgba(0,0,0,0.5)] flex flex-col justify-between p-4 transition-colors group-hover:bg-[#d4b494]">
                <div className="border-b-2 border-[#8b7355]/30 pb-2">
                    ...
                    <div className="h-4 w-full bg-[#141414]/10 mt-1" />
                </div>
              ...
              {/* Тень под папкой */}
              <div className="absolute -z-10 inset-0 bg-black/40 blur-xl translate-y-4" />
            </motion.div>
          ))}
        </div>
          ...
          {openId && current && (
            ...
            >
              ...
              >
                ...
                <div className="flex-1 p-8 lg:p-12 border-b-8 lg:border-b-0 lg:border-r-8 border-[#141414]/10">
                   ...
                   <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-[#141414] p-6 text-white shadow-xl">
                           ...
                           <span className="text-[10px] uppercase font-black opacity-40 block mb-1">Статистика</span>
                           <p className="text-2xl font-black text-[#68191E] uppercase">{current.stat}</p>
                        </div>
                        <div className="bg-white p-6 border-2 border-[#141414] shadow-md">
                           <span className="text-[10px] uppercase font-black opacity-50 block mb-1">Особенности региона</span>
                           <p className="text-sm font-bold italic leading-tight text-[#141414]">{current.compare}</p>
                        </div>
                   </div>
                   </div>
                </div>
                ...
                <div className="w-full lg:w-1/3 bg-[#141414] p-8 lg:p-12 flex flex-col items-center justify-center relative">
                   <div className="relative z-10 text-center">
                      <div className="border-8 border-white p-2 rotate-3 shadow-2xl bg-white mb-6 relative">
                         <img 
                            ...
                            alt={current.narkom} 
                            className="w-48 h-64 object-cover grayscale contrast-125 brightness-110"
                            onError={(e) => (e.currentTarget.src = "https://via.placeholder.com/200x300?text=FOTO")}
                         />
                         <div className="absolute inset-0 bg-[#68191E]/10 mix-blend-multiply" />
                      </div>
                   ...
                   <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[180px] font-black text-white/[0.02] select-none uppercase pointer-events-none">
                     {current.id}
                   </div>
                </div>
              </motion.div>
